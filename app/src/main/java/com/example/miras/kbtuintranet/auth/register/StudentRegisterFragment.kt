...
import kotlinx.android.synthetic.main.fragment_student_register.*
import org.koin.android.ext.android.inject
import org.koin.core.parameter.parametersOf


class StudentRegisterFragment : Fragment(), RegisterContract.View,
    ...
    override fun onClick(p0: View?) {
        when (p0?.id) {
            ...
            R.id.bnRegister -> {
                presenter.registerStudent(etUsername.text.toString(), etPassword.text.toString(), etName.text.toString(),
    ...
    override fun onInsert() {
        presenter.insertStudent(etName.text.toString(), etSurname.text.toString(), etYear.text.toString())
    }
